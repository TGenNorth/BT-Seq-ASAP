...
<xsl:text/>Sample Name<xsl:text>&#x9;</xsl:text>#Reads<xsl:text>&#x9;</xsl:text>Coverage Breadth<xsl:text>&#x9;</xsl:text>SNP Position<xsl:text>&#x9;</xsl:text>Depth<xsl:text>&#x9;</xsl:text>A<xsl:text>&#x9;</xsl:text>C<xsl:text>&#x9;</xsl:text>G<xsl:text>&#x9;</xsl:text>T<xsl:text>&#x9;</xsl:text>_<xsl:text>&#x9;</xsl:text>Significance<xsl:text>&#xa;</xsl:text>
...
<xsl:variable name="NUM_READS" select="amplicon/@reads"/>
<xsl:variable name="BREADTH" select="format-number(amplicon/breadth, '##.##')"/>
<xsl:value-of select="$SAMPLE_NAME"/><xsl:text>&#x9;</xsl:text><xsl:value-of select="$NUM_READS"/><xsl:text>&#x9;</xsl:text><xsl:value-of select="$BREADTH"/>%<xsl:text>&#x9;</xsl:text><xsl:value-of select="significance"/><xsl:text>&#xa;</xsl:text>
</xsl:for-each>
</exsl:document>
</xsl:for-each>
