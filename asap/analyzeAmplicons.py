...
''' % (program_shortdesc, str(__date__))
    ...
    try:
        ...
        optional_group.add_argument("-s", "--submitter", dest="job_manager", help="cluster job submitter to use (PBS, SLURM, SGE, none). [default: PBS]")
        optional_group.add_argument("--submitter-args", dest="sargs", metavar="ARGS", default='', help="additional arguments to pass to the job submitter, enclosed in \"\".")
